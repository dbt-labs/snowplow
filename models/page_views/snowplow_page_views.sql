...
session_prep as (
    ...
    select
        *,
        max(page_view_in_session_index) over (partition by session_id order by
            min_tstamp rows between unbounded preceding and unbounded following)
            as max_session_page_view_index
    from prep
